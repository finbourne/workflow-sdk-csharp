...
namespace Finbourne.Workflow.Sdk.Api
{
    ...
    public interface IWorkersApiSync : IApiAccessor
    {
        ...
        PagedResourceListOfWorker ListWorkers(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0);
        ...
        ApiResponse<PagedResourceListOfWorker> ListWorkersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IWorkersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PagedResourceListOfWorker> ListWorkersAsync(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class WorkersApi : IWorkersApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PagedResourceListOfWorker</returns>
        public PagedResourceListOfWorker ListWorkers(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PagedResourceListOfWorker</returns>
        public Finbourne.Workflow.Sdk.Client.ApiResponse<PagedResourceListOfWorker> ListWorkersWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0)
        {
            Finbourne.Workflow.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Workflow.Sdk.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PagedResourceListOfWorker</returns>
        public async System.Threading.Tasks.Task<PagedResourceListOfWorker> ListWorkersAsync(DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Workflow.Sdk.Client.ApiResponse<PagedResourceListOfWorker> localVarResponse = await ListWorkersWithHttpInfoAsync(asAt, limit, page, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

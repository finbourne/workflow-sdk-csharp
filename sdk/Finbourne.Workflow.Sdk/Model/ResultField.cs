...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class ResultField : IEquatable<ResultField>, IValidatableObject
    {
        /// <summary>
        ...
        public ResultField(string name = default(string), string type = default(string), string displayName = default(string), string description = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ResultField and cannot be null");
            }
            this.Name = name;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ResultField and cannot be null");
            }
            this.Type = type;

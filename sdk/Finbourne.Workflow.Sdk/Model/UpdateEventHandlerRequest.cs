...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateEventHandlerRequest")]
    public partial class UpdateEventHandlerRequest : IEquatable<UpdateEventHandlerRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEventHandlerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateEventHandlerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEventHandlerRequest" /> class.
        /// </summary>
        ...
        public UpdateEventHandlerRequest(string displayName = default(string), string description = default(string), string status = default(string), EventMatchingPattern eventMatchingPattern = default(EventMatchingPattern), ScheduleMatchingPattern scheduleMatchingPattern = default(ScheduleMatchingPattern), EventHandlerMapping runAsUserId = default(EventHandlerMapping), ResourceId taskDefinitionId = default(ResourceId), DateTimeOffset? taskDefinitionAsAt = default(DateTimeOffset?), TaskActivity taskActivity = default(TaskActivity))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdateEventHandlerRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for UpdateEventHandlerRequest and cannot be null");
            }
            this.Status = status;
            // to ensure "runAsUserId" is required (not null)
            if (runAsUserId == null)
            {
                throw new ArgumentNullException("runAsUserId is a required property for UpdateEventHandlerRequest and cannot be null");
            }
            this.RunAsUserId = runAsUserId;
            // to ensure "taskDefinitionId" is required (not null)
            if (taskDefinitionId == null)
            {
                throw new ArgumentNullException("taskDefinitionId is a required property for UpdateEventHandlerRequest and cannot be null");
            }
            this.TaskDefinitionId = taskDefinitionId;
            // to ensure "taskActivity" is required (not null)
            if (taskActivity == null)
            {
                throw new ArgumentNullException("taskActivity is a required property for UpdateEventHandlerRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateEventHandlerRequest);
        }

        /// <summary>
        /// Returns true if UpdateEventHandlerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEventHandlerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEventHandlerRequest input)
        {
            if (input == null)
            {
                return false;

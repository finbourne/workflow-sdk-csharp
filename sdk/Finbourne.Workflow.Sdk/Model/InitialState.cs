...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class InitialState : IEquatable<InitialState>, IValidatableObject
    {
        /// <summary>
        ...
        public InitialState(string name = default(string), List<string> requiredFields = default(List<string>))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for InitialState and cannot be null");
            }
            this.Name = name;

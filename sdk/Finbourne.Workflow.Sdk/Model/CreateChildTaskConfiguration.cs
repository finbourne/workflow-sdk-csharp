...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChildTaskConfiguration")]
    public partial class CreateChildTaskConfiguration : IEquatable<CreateChildTaskConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildTaskConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateChildTaskConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildTaskConfiguration" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>If present, the value of this field on the parent task will be the Stacking Key on any created child tasks</value>
        ...
        {
            return this.Equals(input as CreateChildTaskConfiguration);
        }

        /// <summary>
        /// Returns true if CreateChildTaskConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChildTaskConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChildTaskConfiguration input)
        {
            if (input == null)
            {
                return false;

...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class MetricValue : IEquatable<MetricValue>, IValidatableObject
    {
        ...
        /// <param name="unit">The unit identifier for the value..</param>
        ...
        /// </summary>
        /// <value>The unit identifier for the value.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Unit != null && this.Unit.Length > 1024)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Unit, length must be less than 1024.", new [] { "Unit" });
            }

...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class CreateChildTasksAction : IEquatable<CreateChildTasksAction>, IValidatableObject
    {
        ...
        protected CreateChildTasksAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildTasksAction" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateChildTasksAction);
        }

        /// <summary>
        /// Returns true if CreateChildTasksAction instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChildTasksAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChildTasksAction input)
        {
            if (input == null)
            {
                return false;

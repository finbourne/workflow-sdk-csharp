...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class PropertyValue : IEquatable<PropertyValue>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="labelValue">The value of a text property..</param>
        ...
        /// </summary>
        /// <value>The value of a text property.</value>
        ...
        {
            // LabelValue (string) maxLength
            if (this.LabelValue != null && this.LabelValue.Length > 1024)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LabelValue, length must be less than 1024.", new [] { "LabelValue" });
            }

            // LabelValue (string) minLength
            if (this.LabelValue != null && this.LabelValue.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LabelValue, length must be greater than 0.", new [] { "LabelValue" });
            }

...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RelativeMonthRegularity")]
    public partial class RelativeMonthRegularity : IEquatable<RelativeMonthRegularity>, IValidatableObject
    {
        ...
        protected RelativeMonthRegularity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RelativeMonthRegularity" /> class.
        /// </summary>
        ...
        public RelativeMonthRegularity(int frequency = default(int), List<string> daysOfWeek = default(List<string>), string index = default(string), TypeEnum type = default(TypeEnum))
        {
            ...
            if (daysOfWeek == null)
            {
                throw new ArgumentNullException("daysOfWeek is a required property for RelativeMonthRegularity and cannot be null");
            }
        ...
        {
            return this.Equals(input as RelativeMonthRegularity);
        }

        /// <summary>
        /// Returns true if RelativeMonthRegularity instances are equal
        /// </summary>
        /// <param name="input">Instance of RelativeMonthRegularity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelativeMonthRegularity input)
        {
            if (input == null)
            {
                return false;

...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class EventHandler : IEquatable<EventHandler>, IValidatableObject
    {
        ...
        public EventHandler(ResourceId id = default(ResourceId), VersionInfo varVersion = default(VersionInfo), string displayName = default(string), string description = default(string), string status = default(string), EventMatchingPattern eventMatchingPattern = default(EventMatchingPattern), EventHandlerMapping runAsUserId = default(EventHandlerMapping), ResourceId taskDefinitionId = default(ResourceId), DateTimeOffset? taskDefinitionAsAt = default(DateTimeOffset?), TaskActivityResponse taskActivity = default(TaskActivityResponse))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for EventHandler and cannot be null");
            }
            this.Id = id;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for EventHandler and cannot be null");
            }
            ...
            if (runAsUserId == null)
            {
                throw new ArgumentNullException("runAsUserId is a required property for EventHandler and cannot be null");
            }
            this.RunAsUserId = runAsUserId;
            // to ensure "taskDefinitionId" is required (not null)
            if (taskDefinitionId == null)
            {
                throw new ArgumentNullException("taskDefinitionId is a required property for EventHandler and cannot be null");
            }

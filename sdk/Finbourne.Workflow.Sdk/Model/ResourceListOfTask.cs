...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class ResourceListOfTask : IEquatable<ResourceListOfTask>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfTask(List<Task> values = default(List<Task>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfTask and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;

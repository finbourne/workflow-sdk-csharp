...
namespace Finbourne.Workflow.Sdk.Model
{
    ...
    public partial class CreateWorkflowRequest : IEquatable<CreateWorkflowRequest>, IValidatableObject
    {
        ...
        public CreateWorkflowRequest(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), ResourceId rootTaskDefinitionId = default(ResourceId))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CreateWorkflowRequest and cannot be null");
            }
            this.Id = id;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for CreateWorkflowRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "rootTaskDefinitionId" is required (not null)
            if (rootTaskDefinitionId == null)
            {
                throw new ArgumentNullException("rootTaskDefinitionId is a required property for CreateWorkflowRequest and cannot be null");
            }
